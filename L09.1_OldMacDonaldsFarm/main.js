...
(function (OldMacDonaldsFarm) {
    ...
    */
    ...
    function handleLoad() {
        ...
        let weed = new OldMacDonaldsFarm.Food("weed", 3);
        let meat = new OldMacDonaldsFarm.Food("meat", 3);
        let grass = new OldMacDonaldsFarm.Food("grass", 2);
        let grains = new OldMacDonaldsFarm.Food("grains", 4);
        foodArray = [weed, meat, grass, grains];
        let pig = new OldMacDonaldsFarm.Animal("Luca", "pig", "oink", weed);
        let dog = new OldMacDonaldsFarm.Animal("Dean", "dog", "woof", meat);
        let sheep = new OldMacDonaldsFarm.Animal("Susan", "sheep", "määh", grass);
        let duck = new OldMacDonaldsFarm.Animal("Daisy", "duck", "quack", grains);
        let cat = new OldMacDonaldsFarm.Animal("Cal", "cat", "miau", meat);
    ...
    function silos() {
        ...
        for (let i = 0; i < foodArray.length; i++) {
            ...
            row += 200;
            let siloHeight = -foodArray[a].amount * 100;
            if (siloHeight > 0) {
                siloHeight = 0;
            }
